...
import endpoints, {createImageUrl} from '../src/services/movieServices';
const Hero = () => {
...
<div className = "absolute w-full top-[10%] lg:top-[25%] p-4 md:p-8">
  <h1 className="text-3xl md:text-6xl text-white font-nsans-bold">{title}</h1>
  <div className="mt-8 mb-4">
    <button className="capitalize border bg-gray-300 text-black py-2 px-5 ">play</button>
    <button className="capitalize border text-white border-gray-300 py-2 px-5 ml-4">watch later</button>
  </div>
